...
function App() {
  ...
  return (
    <div className="h-[100vh] flex flex-col relative">
      <div className='bg-gradient-to-b from-indigo-500 to-fuchsia-500 w-[100%] fixed top-0 z-50'>
        ...
        <div className=" h-[380px] w-fit relative mx-auto">
          ...
          {
            !isStart ? (
              <PlayCircleIcon className="h-[5.5rem] text-pink-500 absolute top-[60%] left-[36%] bg-white rounded-[50%] cursor-pointer z-20" onClick={handleStart} />
            ) : (
              <PauseCircleIcon className="h-[5.5rem] text-pink-500 absolute top-[60%] left-[36%] bg-white rounded-[50%] cursor-pointer z-20" onClick={handleStart} />
            )
          }
          <PlusCircleIcon className="h-[3.5rem] text-blue-400 absolute top-[57%] left-[30px] bg-white rounded-[50%] cursor-pointer" onClick={handleLap} />

          <ArrowPathIcon className="h-[3.5rem] text-white absolute top-[55%] left-[73%] bg-blue-400 rounded-[50%] cursor-pointer p-2 border-[6px]" onClick={handleReset} />
